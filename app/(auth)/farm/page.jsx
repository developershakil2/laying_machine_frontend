...
const contact = () => {
 ...
 console.log(barn, 'testing')
  ...
  const feedLenght = () => {
    axios
      .get(`http://localhost:5000/getuniqueuser/${user?.userId || '650b02eb095d4bbcc8aeb60d'}`)
      .then((res) => {
        const data = res.data;
...
const bascicFunc = ()=>{
  ...
  axios.post('http://localhost:5000/buy-barn',{
    userId:user.userId,
    barnName:"bascic",
  ...
  axios.post('http://localhost:5000/buy-barn',{
    ...
    barnPrice:standardBarnPrice
      ...
      if(res.status == 200){
        ...
        const newBarnId = res.data.barn._id
          
           setTimeout(()=>{
            purchaseHandler(newBarnId);
           },4000)
    ...
    <>
      ...
      >
        <div
          ...
          className="w-[320px] backdrop-blur-[30px] flex flex-col p-10 justify-center items-center h-[400px] rounded-xl bg-[#93cae07f]"
        >
          {!m2 ? (
                  ...
                  chicken.map((el, inx) => (
                    <div key={inx} className="my-[65px] relative">
                      ...
                      <img src="images/barn2.png" alt="farm" className="farm_home ml-3 absolute -top-10 -left-10" />
                            ...
                            el.barnName == 'standard' ? <div className="farm_group">

{
                      ...
                      <img src="images/barn2.png" alt="farm" className="farm_home ml-3 absolute -top-10 -left-10" />
                          ...
                          <button  onClick={()=>claim(el._id, el.userId)} className="bg-black   z-10 left-[85px] -bottom-[66px] rounded-xl  text-white font-black px-6 py-2">Sell your Eggs</button>
                           <button onClick={()=>purchaseHandler(el._id)} className="bg-black  z-10 left-[85px] -bottom-[66px] rounded-xl  text-white font-black px-6 py-2">Buy Chicken</button>
                       </div>
