                  ...
                  <div className="w-[350px] backdrop-blur-[20px] shadow-lg z-40 px-6 pt-6 pb-3 rounded-xl bg-transparent border-[1px]">
                         ...
                         <img className="w-[100%] h-[180px] rounded-xl" src="images/refer.png" alt="refer"/>
                          ...
                          <div className="w-full rounded-xl py-2 ">
                            <input  type="text" value={`http://localhost:3000/register/?id=${user.userId}`}  className="outline-none w-full text-white font-black placeholder-white px-2 py-2 rounded-xl border-[1px] bg-transparent"/>
                          </div>
                          <div className="w-full rounded-xl py-2 ">
                          ...
                          <div className="w-full flex justify-center items-center  rounded-xl py-2 ">
                          <button onClick={ ()=> navigator.clipboard.writeText(`http://localhost:3000/register/?id=${user.userId}`) }  className="bg-black rounded-xl p-4 text-white">copy your refer code</button>
